...
function AddAds()
{
  ...
  sed -i "s/000bf1ea7c26767325c439ce0e4d11ec/$wp/g" `grep const-string.*000bf1ea7c26767325c439ce0e4d11ec -rl ./`
...
function HeChengYesAds()
{
  ...
  java -jar lib/Auto-sign/signapk.jar lib/Auto-sign/testkey.x509.pem lib/Auto-sign/testkey.pk8 $1/dist/$1.apk $1/dist/no_ads_$1.apk
  rm -rf $1/dist/$1.apk
