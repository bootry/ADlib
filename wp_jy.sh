...
function AddAds()
{
  cp -r lib/wp_jy/smali $1
  #cp -r lib/wp_jy/assets $1 
  ...
  cd ..
  sed -i '/<\/application>/r lib/wp_jy/manifest.txt' $1/AndroidManifest.xml
...
function HeChengYesAds()
{
  ...
  java -jar lib/Auto-sign/signapk.jar lib/Auto-sign/testkey.x509.pem lib/Auto-sign/testkey.pk8 $1/dist/$1.apk $1/dist/wp_jy_$1.apk
  rm -rf $1/dist/$1.apk
