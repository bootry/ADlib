(function(mapp,$){
    ...
    $(function(){
    	mapp.util.loadCss('http://s1.qhimg.com/static/adef9892852bb952.css', function(){
			var arrPage = jumpToPage();
			var tpl = '<div class="mapp-user-panel" >\
			        <div class="mapp-user-area clearfix" style="width:1000px;margin:0 auto;">\
	...
	function jumpToPage(){
		...
		return ~$.inArray(currPath,toPathSet) ?  location.href : 'http://dev.360.cn';
	}
}(window.mapp||{},jQuery))